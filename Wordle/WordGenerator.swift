...
class WordGenerator {
  ...
  static let possibleWords = ["APPLE", "BIRDS", "CHAIR", "DREAM", "EAGLE", "FLAME", "GRACE", "HORSE", "IGLOO", "JUMBO", "KIWIS", "LEMON", "MAGIC", "NIGHT", "OCEAN", "PANDA", "QUICK", "RADIO", "SALAD", "TIGER", "UMBRA", "VIBES", "WATER", "XYLOP", "YOUTH", "ZEBRA"]
